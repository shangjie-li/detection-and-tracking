...
def extract_object_parameter(xs, ys, zs, radius_threshold=0.5):
    # 功能：提取目标参数
...
if __name__ == "__main__":
    ...
    # 绘制局部坐标系
    axes[5].plot([0, xpl_far], [0, ypl_far], color='black', linewidth=1)
    axes[5].plot([0, xpw_far], [0, ypw_far], color='black', linewidth=1)
